    ...
    <>
      <div>
        ...
        <div className="max-w-[1200px] mx-auto">
          <div className="space-x-[60px] flex justify-between pt-20 ">
            <div className="space-y-6">
              <p className="text-h6 text-danger font-primary font-normal leading-5 tracking-[0.2px]">
                Problems trying
              </p>
              <h3 className="text-h3 text-text font-primary font-bold leading-8 tracking-[0.2px]">
                Met minim Mollie non desert Alamo est sit cliquey dolor do met
                sent.
              </h3>
            </div>
            <div className="flex justify-center py-12">
              <p className="text-h6 text-second-text font-primary font-normal leading-5 tracking-[0.2px]">
          ...
          <div className="flex justify-between pt-20 pb-20">
            <div>
              <h1 className="text-h1 text-text font-primary font-bold leading-20 tracking-[0.2px] ">
                15k
              </h1>
              <h5 className="text-h5 text-second-text font-primary font-bold leading-6 tracking-[0.2px]">
                Happy Customers
              </h5>
            </div>
        ...
        <div className="max-w-[1200px] mx-auto py-28">
          <div className="">
            <h2 className="text-center font-primary font-bold text-h2 text-text leading-12 tracking-[0.2px]">
              Meet Our Team
            </h2>
          </div>

          <div className="flex justify-between flex-wrap gap-x-3.5 pt-28 space-y-28">
            <div className="max-w-[316px]">
              <div className="max-w-[316px] max-h-[231px]">
                <img
                  className="w-full h-full"
                  src="/images/teams/team-1-user-6.jpg"
                  alt=""
                />
              </div>

              <div className="space-y-2.5 py-5 text-center">
                <h5 className="text-h5 text-text font-primary font-bold leading-6 tracking-[0.1px]">
                  Username
                </h5>
                <h6 className="text-h6 text-second-text font-primary font-bold leading-6 tracking-[0.2px]">
                  Profession
                </h6>
                <div className="flex space-x-3 px-28 items-center">
                  <svg
                    width="24"
                    height="23"
                    viewBox="0 0 24 23"
            ...
            <div className="max-w-[316px]">
              <div className="">
                <img
                  className="w-full h-full"
                  src="/images/teams/team-1-user-7.jpg"
                  alt=""
                />
              </div>
            ...
            <div className="max-w-[316px]">
              <div className="">
                <img
                  className="w-full h-full"
                  src="/images/teams/team-1-user-4.jpg"
                  alt=""
                />
              </div>
