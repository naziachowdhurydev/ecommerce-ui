    ...
    <>
      ...
      <div className="max-w-[1200px] mx-auto py-28">
        ...
        <div className="grid grid-cols-3 ">
          <div className="max-w-[327px] mt-10 max-h-[664px] border-primary border-[1px] border-solid rounded-[10px] py-16">
          ...
          <div className="max-w-[329px] max-h-[704px] bg-text border-[1px] border-solid rounded-[10px] py-19 ">
            <div className="text-center space-y-8 pb-4">
